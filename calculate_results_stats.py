...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        if results_dic[key][3] == 1 and results_dic[idx][2] == 1:
    ...
    results_stats_dic['pct_match'] =(results_stats_dic['n_matches']/results_stats_dic['n_images'])*100
                                    
    # Calculates % correct dogs
    results_stats_dic['pct_correct_dogs'] = (results_stats_dic['n_correct_dogs']/
                                             results_stats_dic['n_dogs_images'])*100
    
   # Calculates % correct breed of dog
    results_stats_dic['pct_correct_breed'] = (results_stats_dic['n_correct_breeds']/
                                              results_stats_dic['n_dogs_images'])*100
    
    # Calculates % correct not-a-dog images - using conditional statement for when no 'not a dog' images were  submitted 
    ...
    # return results_stats_dic dictionary that created with this function     
